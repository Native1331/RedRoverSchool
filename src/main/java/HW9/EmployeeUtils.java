...
●	поиск наименьшей надбавки (разнице между базовой ставкой и зарплатой) в массиве менеджеров*/
    ...
    public int findByName(String name, HW8P2.Employee[] arr) {
    ...
    public int findBySubName(String subname, HW8P2.Employee[] arr) {
        for (int i = 0; i < arr.length; i++) {
    ...
    public int findMaxSalary(HW8P2.Worker[] arr) {
